package com.panel.application.views;
...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(ClientsView.class)) {
            nav.addItem(new SideNavItem("Clients", ClientsView.class, LineAwesomeIcon.FILTER_SOLID.create()));

        }
        if (accessChecker.hasAccess(AddClientView.class)) {
            nav.addItem(new SideNavItem("Add Client", AddClientView.class, LineAwesomeIcon.USER.create()));

        }
        if (accessChecker.hasAccess(EditClientView.class)) {
